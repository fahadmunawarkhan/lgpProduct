<div class="col-lg-12">
    <x-layouts.titleSection title="Manage Product/Stocks" :breadcrumbs="[
        ['url' => route('admin.list.product'), 'label' => 'Dashboard', 'icon' => '<i class=\'icon-home\'></i>'],
        ['label' => 'Manage Product/Stocks'],
    ]" />
    ...
    <div class="card">
        <div class="d-flex justify-content-between align-items-center mt-3 m-3">
            <h2 class="mb-0">Product/Stocks</h2>
                            ...
                            <form wire:submit.prevent="save">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" wire:model.lazy="cylinder_material" class="form-control">
