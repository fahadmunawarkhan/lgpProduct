        ...
        <div class="row" style="margin-top: 70px;">
            ...
            <div class="col-md-6" style="display: flow-root;align-content: center;margin-top: 53px;">
                ...
                <form class="mt-4">
                    ...
                    <button type="button" wire:click="add({{ $product->id }})" class="btn btn-success btn-lg w-100"
                        style="margin-top: 20px">Add to
                        Cart</button>

                    <button type="button" wire:click="buyNow({{ $product->id }})" class="btn btn-success btn-lg w-100"
